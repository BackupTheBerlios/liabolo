...
public class ModifyShoppingCartItemsRequest  implements java.io.Serializable {
    ...
    private org.liabolo.common.amazon.ItemQuantity[] items;
    ...
    public org.liabolo.common.amazon.ItemQuantity[] getItems() {
        return items;
    }

    public void setItems(org.liabolo.common.amazon.ItemQuantity[] items) {
        this.items = items;
    }
