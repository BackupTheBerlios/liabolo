...
public class AddShoppingCartItemsRequest  implements java.io.Serializable {
    ...
    private org.liabolo.common.amazon.AddItem[] items;
    ...
    public org.liabolo.common.amazon.AddItem[] getItems() {
        return items;
    }

    public void setItems(org.liabolo.common.amazon.AddItem[] items) {
        this.items = items;
    }
